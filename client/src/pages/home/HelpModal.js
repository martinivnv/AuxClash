	...
	return (
		...
		>
			...
			<p>
				...
				the ultimate playlist! Given a prompt like{" "}
				...
				everyone has 90 seconds to vote on the best pick. At the end of 3
				rounds, all of the songs are compiled into a playlist that can be saved
			...
			<p>
				Have you ever used Kahoot? Aux Clash works just like that. <br /> The
				host needs to sign in to their{" "}
				<span className="font-bold">Spotify</span> account to start a lobby on a{" "}
				<span className="font-bold">laptop, PC, or tablet.</span> <br />{" "}
