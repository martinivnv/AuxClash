	...
	return (
		...
		>
			<button
				...
				className="absolute top-1 right-2 bg-transparent p-2 text-base text-black"
			>
				X
			</button>
			...
			<p>
				...
				<span className="font-bold">
					compiled into a playlist that can be saved to the host's Spotify
				</span>{" "}
				and one person is crowned the{" "}
